...
const MapApiPlace = ({ width = "100%", height = "344px", borderRadius = "20px", coordinateX, coordinateY, level=4 }) => {
    ...
    useEffect(() => {
        ...
        script.onload = () => {
            window.kakao.maps.load(() => {
                if (containerRef.current && coordinateX !== undefined && coordinateY !== undefined) {
                    
                    let defaultCoordinateX = 37.566826;
                    let defaultCoordinateY = 126.9786567;

                    
                    if (coordinateX && coordinateY) {
                        defaultCoordinateX = Number(coordinateX);
                        defaultCoordinateY = Number(coordinateY);
                    }
    ...
    return <div ref={containerRef} id="map" style={{ width: width, height: height, borderRadius: borderRadius }}></div>;
};
